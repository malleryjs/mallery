...
import { dispatchThunk, dispatchPromise } from "alo/store";

import store from "./store";
import "./store/router";
import { setConfig, toggleNavActive } from "./store";
...
export class App {
  ...
  setActiveChapterByLocationHash() {
    if (window.location.hash != "") {
      ...
      if (hashEl != null) {
        const aHashEl: any = hashEl;
        window.scrollTo(0, aHashEl.offsetTop);
        this.mainWrapperRef.current.scrollTop = aHashEl.offsetTop;
        aHashEl.focus();
      }
